...
// Tuve que agregar el paquete yarn add query-string para para procesar el query en partes.
    ...
    <>
      ...
      <div className="row">
        ...
        <div className="col-7">
          ...
          <div className="alert alert-danger animate__animated animate__tada" style={{display: showError ? '' : 'none'}}>No hero with <b>{q}</b></div>
